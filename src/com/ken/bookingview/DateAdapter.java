...
public class DateAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.dayOfWeekView = (TextView) convertView.findViewById(R.id.date_item_day_of_week);
			holder.dayOfWeekView.setLayoutParams(llp);
			holder.dayOfMonthView = (TextView) convertView.findViewById(R.id.date_item_month);
